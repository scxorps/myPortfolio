# 🌟 Mon Portfolio - Mehadji Mohamed El Habib

Portfolio personnel d'un développeur Full Stack passionné par l'innovation technologique.
...
⚡️ Effet de machine à écrire animé\
⚡️ Animations fluides avec ScrollReveal\
⚡️ Stylisé avec Bootstrap + SCSS personnalisé\
⚡️ Compatible mobile et desktop\
⚡️ HTML5 & CSS3 valides\
⚡️ Optimisé avec Parcel\
⚡️ Déploiement automatique GitHub Pages

**URL de démonstration:** `https://scxorps.github.io/myportfolio`
